...
import "../../Style.css"; 
import LatestFacebookPosts from "./../../Marketing/Facebook/LatestFacebookPosts";
import LatestFacebookReels from "./../../Marketing/Facebook/LatestFacebookReels";
import LatestInstagramPosts from "./../../Marketing/Instagram/LatestInstagramPost";
import LatestInstagramReels from "./../../Marketing/Instagram/LatestInstagramReel";
import MetaAdsSummary from "./../../Marketing/MetaAds/MetaAdsSummary"
import MetaAdsInstaSummary from "./../../Marketing/MetaAds/MetaadsInstaSummary";
...
const AdsReportPage = ({ postCount, setInstaPostCount }) => {
...
<div>
    ...
    <div className="p-6 ">
      ...
      <div ref={sectionRefs.PostsSummary} className="pdf-section"style={{ scrollMarginTop: '170px' , display: 'block'}}>
      ...
      <div ref={sectionRefs.MetaAdsPerformance} className="pdf-section py-8"style={{ scrollMarginTop: '170px', display: 'block'}}>
        <div className="p-4">
          <div className="total">
