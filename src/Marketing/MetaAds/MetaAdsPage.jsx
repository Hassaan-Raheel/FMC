...
const MetaAdsPage = ({ setMetaAdCount, setPageTitle }) => {
  ...
  const renderTotalDetails = () => {
    ...
    return (
      <div className="total-details p-4 border border-gray-300 rounded-md shadow-sm">
        <h3 className="text-lg ">Facebook Ads Performance</h3>
    ...
    <div className="p-4">
      ...
      <Collapse>
        <Panel header="All Filters" key="1">
          {/* <div className="filter-item Camp-name">
            ...
            >
              ...
              {Array.from(new Set(metaAds.map((ad) => ad.campaign_name))).map((campaignName) => (
          ...
          <div className="filter-item Camp-id">
            ...
            >
              <option value="">All campaigns</option>
              {Array.from(new Set(metaAds.map((ad) => ad.campaign_id))).map((campaignId) => (
