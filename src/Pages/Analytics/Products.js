...
const ProductsAnalytics = () => {
  ...
  const [componentName, setComponentName] = useState("Product Sales Analytics");
  ...
  const handleMetricChange = (metric, name) => {
    ...
    setComponentName("Product Sales Analytics");
    setMetricName(name);
  };
    ...
    <div className="ProductsAnalytics-Layout">
      ...
      <div className="ProductsAnalytics-Row01">
        <div className="RevenueAnalytics-1stRow">
          <div className="RevenueAnalytics-Title">Products</div>
      ...
      {/*--- Products Analytics Card Section ---*/}
      <div className="ProductsAnalytics-Row01">
      ...
      {/* --- Products API Data Table Section --- */}
      <div className="ProductsAnalytics-Row01">
