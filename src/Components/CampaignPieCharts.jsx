...
const CampaignPieCharts = ({ campaignData }) => {
    ...
    <div className="tab-container">
      <Tabs>
        <TabList className="tab-list">
          <Tab className="tab1">Amount Spent</Tab>
          <Tab className="tab1">Conversions</Tab>
          {/* <Tab className="tab">Audience</Tab> */}
        </TabList>

        <TabPanel>
          <div className="tab1 gridpie">
...
{/* 
        <TabPanel>
          <div className="gridpie">
            <div className="chart-container">
              <h3>Audience by Campaign Type</h3>
              <Pie data={generateChartData(audienceByCampaignType, "Conversions", RED_SHADES)} options={pieChartOptions} />
            </div>
            <div className="chart-container">
              <h3>Audience by Campaign Name</h3>
              <Pie data={generateChartData(audienceByCampaignName, "Conversions", BLUE_SHADES)} options={pieChartOptions} />
            </div>
          </div>
        </TabPanel> */}
      </Tabs>
...
export default CampaignPieCharts;
